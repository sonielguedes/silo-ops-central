            ...
            {sel && (
              <div className="card-p space-y-4">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <DRow label="Estado operacional" value={sel.estado_operacional || "--"} />
                  <DRow label="Último sinal" value={fmtDate(sel.last_seen)} />
                  <DRow label="Há quanto tempo" value={timeAgo(sel.last_seen)} />
                  ...
                  <DRow label="Versão do app" value={sel.app_version || "--"} />
                </div>
              </div>
            )}
          </div>
